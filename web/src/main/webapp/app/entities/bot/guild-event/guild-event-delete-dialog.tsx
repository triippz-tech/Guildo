  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="webApp.botGuildEvent.delete.question">
          <Translate contentKey="webApp.botGuildEvent.delete.question" interpolate={{ id: guildEventEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="gdo-confirm-delete-guildEvent" color="danger" onClick={this.confirmDelete}>
