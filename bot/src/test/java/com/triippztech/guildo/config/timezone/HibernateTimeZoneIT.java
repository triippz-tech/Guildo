package com.triippztech.guildo.config.timezone;

import com.triippztech.guildo.BotApp;
import com.triippztech.guildo.config.TestSecurityConfiguration;
import com.triippztech.guildo.repository.timezone.DateTimeWrapper;
import com.triippztech.guildo.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM gdo_date_time_wrapper where id=%d", fieldName, id);
    }
